...
export const rsuTaxCategoryBox14: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: 'table',
      caption: 'Box 14 labels — they all mean the same thing',
      headers: ['Label', 'What it means'],
      rows: [
        ['RSU / RSU VEST', 'Restricted stock unit vest income (most common)'],
        ['SECT 132', 'Generic "non-cash comp" label (references IRC §132)'],
        ['EQUITY COMP / EQUITY', 'Equity comp — maybe RSU + NSO + ESPP combined'],
        ['STKCMP / STOCK COMP / STK', 'Abbreviated "stock compensation"'],
        ['OFFSET', 'The share-withholding accounting offset'],
        ['NQSO / NQ', 'NSO exercise income (not RSU — different §83 rules)'],
      ],
    },
    ...
    {
      type: 'table',
      caption: 'When Box 14 matters for your state return',
      headers: ['State', 'Why it matters'],
      rows: [
        ['Pennsylvania', 'PA wages exceed federal Box 1; Box 14 helps reconcile'],
        ['New Jersey', 'NJ wage calc differs from federal Box 1'],
        ['California', 'CASDI in Box 14 is deductible; the RSU line is informational'],
        ['Multi-state', 'Box 14 RSU + Box 15–17 split the vest across states'],
      ],
    },
