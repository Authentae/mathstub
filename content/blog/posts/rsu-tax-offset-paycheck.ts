...
export const rsuTaxOffsetPaycheck: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: 'table',
      caption: 'A paystub after 100 RSUs vest at $50 (sell-to-cover)',
      headers: ['Line', 'Amount'],
      rows: [
        ['Regular wages', '+$5,000'],
        ['RSU vest income (the FULL vest)', '+$5,000'],
        ['Federal income tax (22%)', '−$1,100'],
        ['State tax (CA 10.23%)', '−$512'],
        ['Medicare', '−$73'],
        ['Social Security', '−$310'],
        ['401(k) etc.', '−$500'],
        ['RSU tax offset (cancels the vest)', '−$5,000'],
        ['**Net pay**', '**~$2,505**'],
      ],
    },
    {
