...
export function AmazonBookCTA({
  ...
  return (
    <aside className="my-4 rounded-md border border-gray-200 bg-gray-50 p-4 text-sm dark:border-gray-800 dark:bg-gray-900/40">
      <p className="font-medium text-gray-800 dark:text-gray-200">{headline}</p>
