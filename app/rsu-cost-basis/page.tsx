...
import { RsuCostBasisCalculator } from './RsuCostBasisCalculator';
import { rsuCostBasisContent as c } from '@/content/rsu-cost-basis';

export const metadata: Metadata = buildMetadata({
  slug: c.slug,
  title: c.metaTitle,
  description: c.metaDescription,
  ogImagePath: '/og/rsu-cost-basis.png',
});
