...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'A 10-slide visual walkthrough of mathstub.com — the audience, the problem (22% supplemental vs ~37% marginal), the calculator suite, the trust signals (446 unit tests, every claim cites IRC), and the roadmap.',
